...
const testHelpers = require('../tests/test-helpers')
...
describe('Read Directory (promise)', () => {
  ...
  it('should return a promise', () => {
    expect(readDir('./').then).to.be.a('function');
  });

  it('should reject when given a bad path ', () => {
    readDir('./no_test_dir')
      .then((files) => {}, (err) => {
  ...
  it('should return the directory contents ', () => {
    readDir('./test_dir')
      .then((files) => {
